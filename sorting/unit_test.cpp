...
static const int intArray_01[] = {2,1};
static const int intArray_02[] = {3,2,1};
static const int intArray_03[] = {4,3,2,1};
static const int intArray_04[] = {5,4,3,2,1};
static const int intArray_05[] = {5,2,4,10,3,1,7,9,6,8};
static const int intArray_06[] = {5,11,19,2,4,14,15,10,3,20,1,7,9,12,16,6,8,17,13,18};
static const int intArray_07[] = {53,11,190,2,4,134,154,10,3,2000,1,7,990,12,176,688,8,17,13,0,128};
...
static int UT_integer_test(algorithm_t algorithm, int* pass, int* total)
{
	...
	const int* input[] = {intArray_01, intArray_02, intArray_03, intArray_04, intArray_05, intArray_06, intArray_07};
	const int  sizes[] = {sizeof(intArray_01), sizeof(intArray_02), sizeof(intArray_03), sizeof(intArray_04), sizeof(intArray_05), sizeof(intArray_06), sizeof(intArray_07)};
